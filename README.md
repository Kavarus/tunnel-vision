...
[[Создание персонажа-агента]] — глава из книги чуть ли не второй редакции, посвященной как раз агентам правительственных спецслужб. В целом, процесс почти идентичен созданию персонажа-вампира. 

При создании персонажа вам могут пригодиться:
- новое Знание — [[Спецслужбы (знание) | Спецслужбы]];
- новые Факты биографии:
	- [[Защитники]];
	- [[Звание]];
	- [[Снаряжение]] (а доступное оружие и прочее можно посмотреть [[Снаряжение агента | здесь]]);
	- [[Услуги]].
- собрал в один список все доступные вам [[Достоинства и недостатки, доступные для ваших персонажей, агентов ДОР ФБР | достоинства и недостатки]];
- на всякий случай, отдельно описания человеческих [[Добродетели | добродетелей]];
- различные сверхспособности, которые разделяются на несколько групп, а именно:
	- [[Ворожба]];
	- [[Парапсихологический дар]];
	- [[z_Z Правила/HtR v3-v20 (Смертные)/Дары (Numina)/Истинная Вера|Истинная Вера]].
